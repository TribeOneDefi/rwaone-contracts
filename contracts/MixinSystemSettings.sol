...
contract MixinSystemSettings is MixinResolver {
    ...
    bytes32 internal constant SETTING_RWAX_LIQUIDATION_PENALTY = "rwaxLiquidationPenalty";
    ...
    bytes32 internal constant SETTING_CROSS_RWAONE_TRANSFER_ENABLED = "crossChainRwaTransferEnabled";
    ...
    function getRwaxLiquidationPenalty() internal view returns (uint) {
        return flexibleStorage().getUIntValue(SETTING_CONTRACT_NAME, SETTING_RWAX_LIQUIDATION_PENALTY);
    }
    ...
    function getCrossChainRwaTransferEnabled(bytes32 currencyKey) internal view returns (uint) {
        return
            flexibleStorage().getUIntValue(
                SETTING_CONTRACT_NAME,
