...
contract('RewardsDistribution', async accounts => {
	...
	let rewardsDistribution, rwaone, rwaoneProxy, feePool, mockRewardsRecipient;
	...
	it('should set constructor params on deployment', async () => {
		...
		assert.equal(await instance.rwaoneProxy(), account3);
	...
	describe('when the authority is distributing rewards', async () => {
		beforeEach(async () => {
			...
			// Set the wRWAX Token Transfer Address
		...
		it('should send the correct amount of tokens to the listed addresses', async () => {
			...
			// Transfer wRWAX to the RewardsDistribution contract address
