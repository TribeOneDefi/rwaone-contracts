...
module.exports = async ({
	...
	await runStep({
		...
		comment: 'Set the minimum amount of time wRWAX can be issued before any is burned (SIP-40)',
	});
	...
	await runStep({
		...
		comment: 'Set the gas limit for migrating escrowed wRWAX to L2',
	});
	...
	await runStep({
		...
		comment: 'Set the fee rate for minting rETH from ETH in the EtherWrapper (SIP-112)',
	});
	...
	await runStep({
		...
		comment: 'Set the fee rate for burning rETH for ETH in the EtherWrapper (SIP-112)',
	});
